package com.example.sqlite.DatabaseHelpers;
...
public class MyDataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE "+tableName+" (NAME TEXT, SURNAME TEXT, MARKS TEXT, ROLLNO INTEGER PRIMARY KEY)");
    }
    ...
    public boolean insertData(String name,String surname,String marks,String rollNo)
    {
